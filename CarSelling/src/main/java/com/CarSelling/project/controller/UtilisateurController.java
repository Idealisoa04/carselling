...
public class UtilisateurController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<String> insertUtilisateur(@RequestParam(name = "nom") String nom, @RequestParam(name = "prenom") String prenom, @RequestParam(name = "dtn") String dtn, @RequestParam(name = "sexe") Integer sexe, @RequestParam(name = "email") String email, @RequestParam(name="mdp") String mdp) throws Exception{
        try {
